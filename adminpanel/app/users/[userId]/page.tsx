...
export default function UserDetailPage() {
  ...
  return (
    <div>
      ...
      <div style={{marginTop:24,background:'white',borderRadius:12,border:'1px solid #e2e8f0',padding:24}}>
        <h3 style={{marginTop:0,marginBottom:16,fontSize:18,color:'#2d3748'}}>Address</h3>
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:16,fontSize:14,color:'#4a5568'}}>
          <Field label="Address Line 1" value={user.addressLine1} full />
